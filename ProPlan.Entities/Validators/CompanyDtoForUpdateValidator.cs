...
{
    public class CompanyDtoForUpdateValidator : AbstractValidator<CompanyDtoForUpdate>
    {
        public CompanyDtoForUpdateValidator()
        {
            RuleFor(x => x.Id)
            ...
            RuleFor(x => x.CompanyName)
                ...
                .Length(2, 100).WithMessage("Şirket adı 2 ile 100 karakter arasında olmalıdır.");
